...
set CLASSPATH=%APP_HOME%\lib\ConsoleApp-1.0.jar;%APP_HOME%\lib\annotations-20.1.0.jar;%APP_HOME%\lib\postgresql-42.3.1.jar;%APP_HOME%\lib\checker-qual-3.5.0.jar
...
if  not "" == "%CONSOLE_APP_EXIT_CONSOLE%" exit 1
exit /b 1
